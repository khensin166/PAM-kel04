...
class MhsRegister extends StatefulWidget {
  const MhsRegister({super.key});

  @override
  State<MhsRegister> createState() => _MhsRegisterState();
}

class _MhsRegisterState extends State<MhsRegister> {
                ...
                children: [
                  input_widget(
                    ...
                    icon: Icon(
                      ...
                      color: _ktpController.text.isEmpty
                  ...
                  input_widget(
                      ...
                      icon: Icon(
                        Icons.phone,
                        color: _handphoneController.text.isEmpty
                            ? const Color(0xFF151624).withOpacity(0.5)
                            : const Color.fromRGBO(44, 185, 176, 1),
                        size: 20,
                      ),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    await _mhsAuthenticationController.register(
                  ...
                  child: Container(
                    ...
                    alignment: Alignment.center,
                    child: Obx(() {
                      return _mhsAuthenticationController.isLoading.value
                          ? const Center(
          ...
          children: [
            TextSpan(
              ...
              recognizer: TapGestureRecognizer()
                ..onTap = () {
                  // Perform the action you want when "Sign Up here" is tapped
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const MhsLogin()));
                },
            ),
          ],
        ),
